...
// User Profile
Route::get('/user/profile', [ChangePasswordController::class, 'PUpdate'])->name('profile.update');
Route::post('/user/profile/update', [ChangePasswordController::class, 'UpdateProfile'])->name('update.user.profile');
